...
namespace Identity.Infrastructure.Services.Interfaces
{
    public class TokenService : ITokenService
    {
        ...
        public Task<ClaimsPrincipal> GetPrincipalFromExpiredToken(string expiredAccessToken)
        {
            ...
            var principal = tokenHandler.ValidateToken(expiredAccessToken, tokenValidationParameters, out var securityToken);
